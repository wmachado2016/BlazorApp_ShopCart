...
namespace BlazorAppShop.WebApi.Migrations
{
    ...
    [Migration("20240515115326_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorAppShop.Models.Entities.Carrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppShop.Models.Entities.CarrinhoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppShop.Models.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppShop.Models.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppShop.Models.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppShop.Models.Entities.CarrinhoItem", b =>
                {
                    b.HasOne("BlazorAppShop.Models.Entities.Carrinho", "Carrinho")
                        .WithMany("Itens")
                        .HasForeignKey("CarrinhoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorAppShop.Models.Entities.Produto", "Produto")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("BlazorAppShop.Models.Entities.Produto", b =>
                {
                    b.HasOne("BlazorAppShop.Models.Entities.Categoria", "Categoria")
                        .WithMany("Produtos")
